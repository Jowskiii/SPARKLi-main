...
def save_post_reading_level(request):
    if request.method == 'POST':
        ...
        logger.debug(f'Post Reading Level: {post_reading_level}')
...
def analyze_similarity(request):
    if request.method == "POST":
        try:
            ...
            with open(r'C:\Users\Maria Lyn\Downloads\SPARKLi-main (1)\SPARKLi-main\models\rf_classifier.pkl', 'rb') as f:
                rf_classifier = pickle.load(f)

            with open(r'C:\Users\Maria Lyn\Downloads\SPARKLi-main (1)\SPARKLi-main\models\rf_literal_feedback.pkl', 'rb') as f:
                rf_literal_feedback = pickle.load(f)

            with open(r'C:\Users\Maria Lyn\Downloads\SPARKLi-main (1)\SPARKLi-main\models\rf_inferential_feedback.pkl', 'rb') as f:
                rf_inferential_feedback = pickle.load(f)

            with open(r'C:\Users\Maria Lyn\Downloads\SPARKLi-main (1)\SPARKLi-main\models\rf_applied_feedback.pkl', 'rb') as f:
                rf_applied_feedback = pickle.load(f)

            with open(r'C:\Users\Maria Lyn\Downloads\SPARKLi-main (1)\SPARKLi-main\models\rf_level_feedback.pkl', 'rb') as f:
